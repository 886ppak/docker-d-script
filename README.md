...
`d` is a lightweight Bash script to manage Docker Compose stacks easily. Start, stop, restart, pull images, view status/logs, or safely “nuke” a stack — all from one command. ⚡
